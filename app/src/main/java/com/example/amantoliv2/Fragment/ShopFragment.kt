...
class ShopFragment : Fragment() {
    ...
    private fun setCategoryData() {
        cateList.add(Category("En barro","https://images.unsplash.com/photo-1609881582722-4a8ab7cd54d8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80"))
